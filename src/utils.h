...
/* Formats int16_t/uint16_t vectors to be printable as hex strings or other arbitrary format */
std::string format_vec(const int16_t *vec, size_t len, const char *format = nullptr);
